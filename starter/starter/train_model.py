...
from ml.model import train_model, inference, slice_performance, \
    compute_model_metrics, export_model_files
import pandas as pd
...
precision, recall, fbeta, accuracy = compute_model_metrics(y_train,
                                                           y_train_preds)
