...
def run_sanity_check(test_dir):
    ...
    if not test_functions_for_post:
        ...
        if not TEST_FOR_POST_METHOD_RESPONSE_CODE:
            ...
            print(FAIL_COLOR + "One or more of your test cases for POST() "
                               "do not seem to be testing the response "
                               "code.\n")
    ...
    print(
        WARN_COLOR + "This is a heuristic based sanity testing and "
                     "cannot guarantee the correctness of your code.")
    print(
        WARN_COLOR + "You should still check your work against the rubric "
